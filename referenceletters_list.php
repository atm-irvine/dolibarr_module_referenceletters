...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->rights->referenceletters->referenceletters->write;
	$permissiontodelete = $user->rights->referenceletters->referenceletters->delete;
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ReferenceLetters';
	$objectlabel = 'ReferenceLetters';
	$uploaddir = $conf->referenceletters->dir_output;
...
$topicmail = "SendReferenceLettersRef";
...
if (in_array('builddoc', $arrayofmassactions) && ($nbtotalofrecords === '' || $nbtotalofrecords)) {
	...
	print $formfile->showdocuments('massfilesarea_referenceletters', '', $filedir, $urlsource, 0, $delallowed, '', 1, 1, 0, 48, 1, $param, $title, '', '', '', null, $hidegeneratedfilelistifempty);
}
